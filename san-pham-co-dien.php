        ...
        <div class="product-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 30px; align-items: stretch; margin-bottom: 40px;">
            ...
            <div class="product-card item-gen" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/z2209179581264_2245d21c733ed0a98a6260e9d9fb7e05.jpg" alt="ATS 825 kVA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
            ...
            <div class="product-card item-gen" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png" alt="Baudouin 1000/1100 kVA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-gen" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png" alt="Baudouin 1280/1410 kVA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-gen" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png" alt="Baudouin 1400/1540 kVA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-gen" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png" alt="Baudouin 1500/1650 kVA" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
    ...
    <div class="container">
        ...
        <div class="product-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 30px; align-items: stretch; margin-bottom: 40px;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BA125-adv01-600x600-1.png" alt="BA125 – Pin xe con hạng nhẹ" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BA140-600x600-1.jpg" alt="BA140 – Pin xe con máy xăng" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BA160-600x600-1.jpg" alt="BA160 – Pin xe con máy dầu" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BA180-600x600-1.jpg" alt="BA180 – Pin xe địa hình máy dầu" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BA180-600x600-1.jpg" alt="BA208 – Pin xe tải nhẹ" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BP212-600x600-1.jpg" alt="BA212 – Pin xe tải nặng, đầu kéo" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/logo-VIBAT-600x575-1.png" alt="BB140 – Pin xe điện Vinfast tăng cường 60Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BB125-600x600-1.jpg" alt="BB125 – Pin xe điện Vinfast tiêu chuẩn 45Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="1" style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BB125-600x600-1.jpg" alt="BB115 – Pin xe điện Vinfast nhỏ 30Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP110-600x600-1.jpg" alt="BP110: Pin xe máy 12.8V-4.8Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BPS106-600x600-1.jpg" alt="BM105: Pin xe máy 4Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP110-600x600-1.jpg" alt="BM120: Pin xe máy 16Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP106-600x600-1.jpg" alt="BP106: Pin xe máy 12.8V-2.4Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/logo-VIBAT-600x575-1.png" alt="PS140.15 – Pin xe dịch vụ máy xăng" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP115-adv02-600x600-1.png" alt="BP115: Pin xe máy 12.8V-7.2Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP110-600x600-1.jpg" alt="BM115: Pin xe máy 12Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/BP110-600x600-1.jpg" alt="BM110: Pin xe máy 8Ah" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div class="product-card item-bat" data-page="2" style="display: none; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="https://apollotech.vn/wp-content/uploads/2026/02/Hinh-dai-dien-BA160-600x600-1.jpg" alt="PS160.15 – Pin xe dịch vụ máy dầu" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
