...
<section style="background:#fff; padding:64px 0;">
    <div class="container">
        ...
        <div class="product-grid"
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="<?php echo get_content('san-pham-co-dien', 'prod_img_1', 'https://apollotech.vn/wp-content/uploads/2026/02/z2209179581264_2245d21c733ed0a98a6260e9d9fb7e05.jpg'); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_1'); ?> alt="ATS 825 kVA"
            ...
            <div class="product-card item-gen" data-page="1"
                style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="<?php echo get_content('san-pham-co-dien', 'prod_img_2', 'https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png'); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_2'); ?> alt="Baudouin 1000/1100 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Động cơ:</strong>
                            8M33G1100/5</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            4.5x2.05x2.4 m</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 7220
                            kg</div>
            ...
            <div class="product-card item-gen" data-page="1"
                style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="<?php echo get_content('san-pham-co-dien', 'prod_img_3', 'https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png'); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_3'); ?> alt="Baudouin 1280/1410 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        ...
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            5.1x2.2x2.6 m</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 10540
                            kg</div>
            ...
            <div class="product-card item-gen" data-page="1"
                style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="<?php echo get_content('san-pham-co-dien', 'prod_img_4', 'https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png'); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_4'); ?> alt="Baudouin 1400/1540 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        ...
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            5.2x2.2x2.6 m</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 10940
                            kg</div>
            ...
            <div class="product-card item-gen" data-page="1"
                style="display: flex; flex-direction: column; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); transition: transform 0.3s; border: 1px solid #eee; height: 100%;">
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img src="<?php echo get_content('san-pham-co-dien', 'prod_img_5', 'https://apollotech.vn/wp-content/uploads/2026/02/126845237_222874382735991_4521912268779557297_n.png'); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_5'); ?> alt="Baudouin 1500/1650 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        ...
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            5.2x2.2x2.6 m</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 13330
                            kg</div>
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_24', SITE . "/img/dzima/DZM-DE424G.png"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_24'); ?> alt="Động Cơ 30 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    <h3 <?php echo cms_attr('san-pham-co-dien', 'prod_name_24'); ?>
                        ...
                        Động Cơ 30 kVA</h3>
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DE436G
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Động cơ:</strong> 30-33kW
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            1.7x0.7x1.07 m</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 360
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_25', SITE . "/img/dzima/DZM-DE424G.png"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_25'); ?> alt="Động Cơ 20 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    <h3 <?php echo cms_attr('san-pham-co-dien', 'prod_name_25'); ?>
                        ...
                        Động Cơ 20 kVA</h3>
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DE427G
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Động cơ:</strong>
                            22-24.2kW</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            900x650x800 mm</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 230
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_26', SITE . "/img/dzima/DZM-DG184H.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_26'); ?> alt="Đầu Phát 31.3 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DG184G
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            522x410x434 mm</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 56.0
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_27', SITE . "/img/dzima/DZM-DG184H.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_27'); ?> alt="Đầu Phát 20 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    <h3 <?php echo cms_attr('san-pham-co-dien', 'prod_name_27'); ?>
                        ...
                        Đầu Phát 20 kVA</h3>
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DG184F-S
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            522x410x434 mm</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 49.7
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_28', SITE . "/img/dzima/DZM-DG184H.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_28'); ?> alt="Đầu Phát 13 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    <h3 <?php echo cms_attr('san-pham-co-dien', 'prod_name_28'); ?>
                        ...
                        Đầu Phát 13 kVA</h3>
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DG164D-S
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            392x403x456 mm</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 34.5
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_29', SITE . "/img/dzima/DZM-DG184H.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_29'); ?> alt="Đầu Phát 11 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    <h3 <?php echo cms_attr('san-pham-co-dien', 'prod_name_29'); ?>
                        ...
                        Đầu Phát 11 kVA</h3>
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> DG164C-S
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            392x403x456 mm</div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Khối lượng:</strong> 31.4
                            kg</div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_30', SITE . "/img/dzima/4c2cda0885c674982dd7.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_30'); ?> alt="Tủ Hòa Đồng Bộ 2640 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> VG4000SM
                        </div>
                    </div>
                    <a href="<?php echo SITE; ?>/lien-he.php" class="btn btn-outline"
                        style="text-align: center; width: 100%; padding: 10px; border-radius: 6px; color: #0066CC; border: 1px solid #0066CC; font-weight: 500; text-decoration: none; transition: all 0.3s; display: block; margin-top: auto;">
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_31', SITE . "/img/dzima/4c2cda0885c674982dd7.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_31'); ?> alt="Tủ Hòa Đồng Bộ 2112 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> VG3200SM
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            80x140x220 cm</div>
                    </div>
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_32', SITE . "/img/dzima/4c2cda0885c674982dd7.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_32'); ?> alt="Tủ Hòa Đồng Bộ 1650 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> VG2500SM
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            80x140x220 cm</div>
                    </div>
            ...
            <div class="product-card item-gen" data-page="1"
                ...
                <div class="pc-img" style="position: relative; width: 100%; padding-top: 100%; background: #fff;">
                    <img class="img-fluid"
                        src="<?php echo get_content('san-pham-co-dien', 'prod_img_33', SITE . "/img/dzima/4c2cda0885c674982dd7.jpg"); ?>"
                        <?php echo cms_img_attr('san-pham-co-dien', 'prod_img_33'); ?> alt="Tủ Hòa Đồng Bộ 1320 kVA"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
                </div>
                <div class="pc-body" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1;">
                    ...
                    <div class="pc-spec" style="flex-grow: 1; margin-bottom: 20px;">
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Model:</strong> VG2000SM
                        </div>
                        <div style="font-size:0.9rem; color:#555; margin-bottom:4px;"><strong>Kích thước:</strong>
                            80x140x220 cm</div>
                    </div>
