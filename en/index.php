            ...
            <div class="hero-content">
                ...
                <div style="display:flex; flex-wrap:wrap; margin-bottom:32px; color:rgba(255,255,255,0.85);">
                    <ul style="flex:1; list-style:none; padding:0; margin:0; font-size:0.95rem;">
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Hạ tầng CNTT</li>
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Hệ thống an ninh</li>
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Hệ thống cơ điện (M&E)</li>
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Giải pháp phần mềm</li>
                    </ul>
                    <ul style="flex:1; list-style:none; padding:0; margin:0; font-size:0.95rem;">
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Giải pháp an ninh</li>
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Hệ thống AV</li>
                        <li style="margin-bottom:10px;"><i class="fas fa-check-circle" style="color:var(--c-blue); margin-right:8px;"></i>Giải pháp IoT</li>
                    </ul>
                </div>
                ...
                <div class="hero-stats">
                    <div><div class="hstat-num"><span <?php echo cms_attr('index', 'stat_1_num'); ?>><?php echo get_content('index', 'stat_1_num', '100'); ?></span><em>+</em></div><div class="hstat-lbl"><span <?php echo cms_attr('index', 'stat_1_lbl'); ?>><?php echo get_content('index', 'stat_1_lbl', 'Dự án'); ?></span></div></div>
                    <div><div class="hstat-num"><span <?php echo cms_attr('index', 'stat_2_num'); ?>><?php echo get_content('index', 'stat_2_num', '50'); ?></span><em>+</em></div><div class="hstat-lbl"><span <?php echo cms_attr('index', 'stat_2_lbl'); ?>><?php echo get_content('index', 'stat_2_lbl', 'Đối tác'); ?></span></div></div>
                    <div><div class="hstat-num"><span <?php echo cms_attr('index', 'stat_3_num'); ?>><?php echo get_content('index', 'stat_3_num', '7'); ?></span><em>+</em></div><div class="hstat-lbl"><span <?php echo cms_attr('index', 'stat_3_lbl'); ?>><?php echo get_content('index', 'stat_3_lbl', 'Giải pháp'); ?></span></div></div>
                    <div><div class="hstat-num"><span <?php echo cms_attr('index', 'stat_4_num'); ?>><?php echo get_content('index', 'stat_4_num', '10'); ?></span><em>+</em></div><div class="hstat-lbl"><span <?php echo cms_attr('index', 'stat_4_lbl'); ?>><?php echo get_content('index', 'stat_4_lbl', 'Năm KN'); ?></span></div></div>
                </div>
            </div>
            <!-- Visual -->
...
<section class="partners">
    <div class="container">
        <p class="partners-label">Lấy sự hài lòng của khách hàng làm thước đo thành công,<br>Apollo Technologies cam kết đồng hành bền vững và mang lại giá trị thực tiễn tối ưu cho Quý đối tác.</p>
    ...
    <div class="container">
        <div class="sect-header-2col">
            <div>
                ...
                <h2 class="section-title" <?php echo cms_attr('index', 'proj_sect_title'); ?>><?php echo get_content('index', 'proj_sect_title', 'DỰ ÁN <span>TIÊU BIỂU</span>'); ?></h2>
                <p class="section-desc" <?php echo cms_attr('index', 'proj_sect_desc'); ?>><?php echo get_content('index', 'proj_sect_desc', 'Chúng tôi mang đến những giải pháp công nghệ tiên tiến, giúp tối ưu hóa vận hành và thúc đẩy sự phát triển bền vững cho đối tác. Những dự án dưới đây đại diện cho tiêu chuẩn cao nhất mà Apollo Technologies luôn hướng tới trong mọi hành trình đồng hành.'); ?></p>
            </div>
            <div>
                <a href="<?php echo SITE;?>/loai-hinh-du-an.php" class="btn btn-outline"><i class="fas fa-th-large"></i> <span <?php echo cms_attr('index', 'proj_sect_btn'); ?>><?php echo get_content('index', 'proj_sect_btn', 'Xem tất cả'); ?></span></a>
            </div>
        </div>
...
<section class="solutions-sect">
    <div class="container">
        <div class="two-col">
            ...
            <!-- List -->
            <div>
                <span class="section-tag" style="background:transparent; padding:0; color:var(--c-blue); margin-bottom:10px; font-weight:700;"><i class="fas fa-minus"></i></span>
                <h2 class="section-title" <?php echo cms_attr('index', 'sol_sect_title'); ?>><?php echo get_content('index', 'sol_sect_title', 'Chúng tôi cung cấp các giải pháp'); ?></h2>
                <ul style="list-style:none; padding:0; margin-top:30px;">
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_1'); ?>><?php echo get_content('index', 'sol_item_1', 'Hệ thống CNTT (ICT Infrastructure)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_2'); ?>><?php echo get_content('index', 'sol_item_2', 'Giải pháp an ninh (Security Solutions)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_3'); ?>><?php echo get_content('index', 'sol_item_3', 'Hệ thống viễn thông (Telecommunication Systems)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_4'); ?>><?php echo get_content('index', 'sol_item_4', 'Hệ thống AV (Audio Visual)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_5'); ?>><?php echo get_content('index', 'sol_item_5', 'Giải pháp phần mềm (Software Solutions)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_6'); ?>><?php echo get_content('index', 'sol_item_6', 'Hệ thống cơ điện (M&amp;E)'); ?></span></li>
                    <li style="margin-bottom:16px; font-weight:600; font-size:1.05rem; display:flex; align-items:center;"><i class="fas fa-check-circle" style="color:var(--c-blue); font-size:1.2rem; margin-right:12px;"></i> <span <?php echo cms_attr('index', 'sol_item_7'); ?>><?php echo get_content('index', 'sol_item_7', 'Giải pháp IoT (Internet of Things)'); ?></span></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="value-sect">
    <div class="container">
        <div class="value-grid">
            <!-- Left -->
            <div>
                <span class="section-tag light" style="background:transparent; padding:0; color:var(--c-blue); margin-bottom:10px; font-weight:700;" <?php echo cms_attr('index', 'vl_sect_tag'); ?>><i class="fas fa-minus"></i> <?php echo get_content('index', 'vl_sect_tag', ''); ?></span>
                <h2 class="section-title on-dark" <?php echo cms_attr('index', 'vl_sect_title'); ?>><?php echo get_content('index', 'vl_sect_title', 'Giải pháp công nghệ<br>toàn diện cho <span>doanh nghiệp</span>'); ?></h2>
                ...
                <div class="stat-strip">
                    <div class="stat-block">
                        <div class="stat-num"><span data-target="100">0</span><em>+</em></div>
                        <div class="stat-lbl">Dự Án</div>
                    </div>
                    <div class="stat-block">
                        <div class="stat-num"><span data-target="50">0</span><em>+</em></div>
                        <div class="stat-lbl">Đối Tác</div>
                    </div>
                    <div class="stat-block">
                        <div class="stat-num"><span data-target="10">0</span><em>+</em></div>
                        <div class="stat-lbl">Năm KN</div>
                    </div>
                </div>
            </div>
            <!-- Right -->
            <div>
                <p style="font-family:'Montserrat',sans-serif;font-size:.72rem;font-weight:800;color:rgba(255,255,255,.35);letter-spacing:2px;text-transform:uppercase;margin-bottom:20px;" <?php echo cms_attr('index', 'vl_sub'); ?>><?php echo get_content('index', 'vl_sub', 'APOLLO TECHNOLOGIES ĐỒNG HÀNH CÙNG BẠN'); ?></p>

                <div class="value-card">
                    <div class="val-icon" style="background:transparent;"><i class="fas fa-check-circle" style="color:#FF4C4C; font-size:2rem;"></i></div>
                    <div class="val-body">
                        <h4 <?php echo cms_attr('index', 'vl_card1_t'); ?>><?php echo get_content('index', 'vl_card1_t', 'Chất lượng Đột phá – Công nghệ Đổi mới'); ?></h4>
                        <p <?php echo cms_attr('index', 'vl_card1_d'); ?>><?php echo get_content('index', 'vl_card1_d', 'Chúng tôi cam kết mang đến hệ sinh thái sản phẩm và dịch vụ đạt tiêu chuẩn chất lượng cao nhất. Bằng việc liên tục nghiên cứu và tiên phong ứng dụng các công nghệ mới, Apollo Technologies nỗ lực tối ưu hóa trải nghiệm, giúp khách hàng bứt phá trong kỷ nguyên số.'); ?></p>
                    </div>
                </div>
                <div class="value-card">
                    <div class="val-icon" style="background:transparent;"><i class="fas fa-check-circle" style="color:#FF4C4C; font-size:2rem;"></i></div>
                    <div class="val-body">
                        <h4 <?php echo cms_attr('index', 'vl_card2_t'); ?>><?php echo get_content('index', 'vl_card2_t', 'Tận tâm Đồng hành – Hỗ trợ Toàn diện'); ?></h4>
                        <p <?php echo cms_attr('index', 'vl_card2_d'); ?>><?php echo get_content('index', 'vl_card2_d', 'Khách hàng là trọng tâm trong mọi hoạt động của chúng tôi. Với đội ngũ hỗ trợ chuyên nghiệp, thân thiện và quy trình phản hồi thông tin linh hoạt, chúng tôi đảm bảo mọi yêu cầu của Quý khách đều được đáp ứng nhanh chóng, chính xác và hiệu quả nhất.'); ?></p>
                    </div>
                </div>
                <div class="value-card">
                    <div class="val-icon" style="background:transparent;"><i class="fas fa-check-circle" style="color:#FF4C4C; font-size:2rem;"></i></div>
                    <div class="val-body">
                        <h4 <?php echo cms_attr('index', 'vl_card3_t'); ?>><?php echo get_content('index', 'vl_card3_t', 'Bảo mật Tuyệt đối – Tin cậy Vững bền'); ?></h4>
                        <p <?php echo cms_attr('index', 'vl_card3_d'); ?>><?php echo get_content('index', 'vl_card3_d', 'Chúng tôi hiểu rằng dữ liệu là tài sản quý giá nhất của doanh nghiệp. Apollo Technologies thiết lập hệ thống bảo mật đa tầng, cam kết bảo vệ an toàn tuyệt đối và duy trì tính toàn vẹn cho mọi thông tin của đối tác. Đây chính là nền tảng cốt lõi để xây dựng một mối quan hệ hợp tác bền vững và tin cậy.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<section style="background:var(--g-blue);padding:64px 0;text-align:center;">
    <div class="container">
        ...
        <h2 style="font-family:'Montserrat',sans-serif;font-size:2.1rem;font-weight:900;color:#fff;letter-spacing:-.4px;margin-bottom:14px;" <?php echo cms_attr('index', 'cta_title'); ?>>
        ...
        <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;">
            <a href="<?php echo SITE;?>/lien-he.php" class="btn" style="background:#fff;color:var(--c-blue);font-weight:800;">
